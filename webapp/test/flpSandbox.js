					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#registrationform-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"registrationform-display": {
								"semanticObject": "registrationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=registrationform",
									"url": sap.ui.require.toUrl("registrationform")
								}
							}
						}
					}
